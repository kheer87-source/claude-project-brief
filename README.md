...
1. Download `Claude Project Brief Template.md`
2. Open a Claude.ai project
3. Paste this prompt into a new chat:
...
4. Review the output, add the rules only you know from experience, and upload the finished Brief to your project knowledge area
5. From that point on, Claude applies your rules automatically at the start of every session
6. Keep it updated. Every time a session uncovers a new rule, a broken assumption, or a hard-won constraint, add it to the Brief before closing the session. A Brief that stops being updated stops being useful. The value compounds the longer you maintain it. This is not a one-time setup. It is a living document.
...
| File | Description |
|---|---|
| `Claude Project Brief Template.md` | The full template with worked example and guidance |
| `README.md` | This file |
